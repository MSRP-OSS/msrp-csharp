...
{
    /// <summary>
    /// Interface used with ThreadGroup to create a thread which needs to implement a Run function which will be called when the thread needs to be executed
    /// </summary>
    public interface IRunnable
    {
        /// <summary>
        /// Function called when a thread is executed
        /// </summary>
        void Run();
    }
}
