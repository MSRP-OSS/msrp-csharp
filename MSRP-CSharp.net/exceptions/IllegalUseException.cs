...
namespace MSRP.Exceptions
{
    ...
    /// 
    /// </summary>
    public class IllegalUseException : Exception
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public IllegalUseException(Exception innerException)
        ...
        /// <param name="message"></param>
        /// <param name="innerException"></param>
        public IllegalUseException(string message, Exception innerException)
