...
namespace MSRP.Exceptions
{
    ...
    /// 
    /// </summary>
    public class NonValidSessionSuccessReportException : Exception
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public NonValidSessionSuccessReportException(string message)
            : this(message, null)
        {
        ...
        public NonValidSessionSuccessReportException(Exception innerException)
        ...
        /// <param name="message"></param>
        /// <param name="innerException"></param>
        public NonValidSessionSuccessReportException(string message, Exception innerException)
